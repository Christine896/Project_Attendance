...
router.get('/stats/:studentId', verifyToken, async (req, res) => {
    try {
        ...
        const stats = await Promise.all(courseUnits.map(async (unit) => {
            ...
            // SURGICAL FIX: Count the ACTUAL sessions generated by the lecturer, not the drifting Unit counter
            ...
            if (actualTotalSessions >= 3 && percent < 75) {
            ...
            // Return the truthful actualTotalSessions
